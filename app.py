...
if st.button(">>> ประมวลผลส่วนผสม (CALCULATE) <<<", type="primary"):
    ...
    # Validation Check: ตรวจสอบขอบเขตกำลังอัด
    if fc_req > 80 and unit_system == "SI Units (MPa, kg, mm)":
        ...
        fm_target = fm_metric / control_factor # คำนวณกำลังเป้าหมายตาม Control Factor
        
        # สมการหา W/C จากงานวิจัย Aguwa (2025)
        ...
        with res2:
            ...
            # คำนวณการปรับแก้ความชื้นจริงหน้างาน
            ...
            st.info(f"สัดส่วนโดยประมาณ 1 : {(sand_ssd/cc):.2f} : 3.50")
