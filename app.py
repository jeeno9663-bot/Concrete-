...
with col_c:
    ...
    # เพิ่มการรับค่า % Passing สำหรับทราย
...
# ==========================================
# ฟังก์ชันคำนวณ PFA (60 สมการจากงานวิจัย)
# ==========================================
def get_pfa(max_agg, slump, p_passing, fwc_ratio):
    ...
    if max_agg == 10:
        ...
        elif 60 <= slump <= 200: # ปรับขอบเขตบนเพื่อรองรับ slump ที่กรอกเข้ามา
...
if st.button(">>> ประมวลผลส่วนผสมคอนกรีต (CALCULATE) <<<", type="primary", use_container_width=True):
    ...
    if fm_metric > 80.0:
        ...
        fm_target = fm_metric / control_factor # กำลังอัดเป้าหมาย
        ...
        # 6. หาสัดส่วนทราย (ดึงสมการ 60 ชุด)
